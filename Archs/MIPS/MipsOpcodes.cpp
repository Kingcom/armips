...
//		*1 = SPECIAL	*2 = REGIMM		*3 = COP0		*4 = COP1		*5 = COP2
	...
	{ "cache",	"t,i16(s)",			MIPS_OP(0x2F),			MA_MIPS2,	0 },
...
//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
	...
	{ "mfc2",	"t,Rs[Re]",		MIPS_COP2(0x00),				MA_RSP, MO_RSP_VEALT },
	{ "cfc2",	"t,d",			MIPS_COP2(0x02),				MA_RSP },
	{ "mtc2",	"t,Rs[Re]",		MIPS_COP2(0x04),				MA_RSP, MO_RSP_VEALT },
...
//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
	{ "vmulf",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x00),			MA_RSP, 0 },
	{ "vmulf",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x00),			MA_RSP, 0 },
	{ "vmulf",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x00),			MA_RSP, MO_RSPVRSD },
	{ "vmulf",	"Rs,Rt",			MIPS_COP2_RSP(0x00),			MA_RSP, MO_RSPVRSD },
	{ "vmulu",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x01),			MA_RSP, 0 },
	{ "vmulu",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x01),			MA_RSP, 0 },
	{ "vmulu",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x01),			MA_RSP, MO_RSPVRSD },
	{ "vmulu",	"Rs,Rt",			MIPS_COP2_RSP(0x01),			MA_RSP, MO_RSPVRSD },
	{ "vrndp",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x02),			MA_RSP, 0 },
	{ "vrndp",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x02),			MA_RSP, 0 },
	{ "vrndp",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x02),			MA_RSP, MO_RSPVRSD },
	{ "vrndp",	"Rs,Rt",			MIPS_COP2_RSP(0x02),			MA_RSP, MO_RSPVRSD },
	{ "vmulq",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x03),			MA_RSP, 0 },
	{ "vmulq",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x03),			MA_RSP, 0 },
	{ "vmulq",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x03),			MA_RSP, MO_RSPVRSD },
	{ "vmulq",	"Rs,Rt",			MIPS_COP2_RSP(0x03),			MA_RSP, MO_RSPVRSD },
	{ "vmudl",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x04),			MA_RSP, 0 },
	{ "vmudl",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x04),			MA_RSP, 0 },
	{ "vmudl",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x04),			MA_RSP, MO_RSPVRSD },
	{ "vmudl",	"Rs,Rt",			MIPS_COP2_RSP(0x04),			MA_RSP, MO_RSPVRSD },
	{ "vmudm",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x05),			MA_RSP, 0 },
	{ "vmudm",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x05),			MA_RSP, 0 },
	{ "vmudm",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x05),			MA_RSP, MO_RSPVRSD },
	{ "vmudm",	"Rs,Rt",			MIPS_COP2_RSP(0x05),			MA_RSP, MO_RSPVRSD },
	{ "vmudn",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x06),			MA_RSP, 0 },
	{ "vmudn",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x06),			MA_RSP, 0 },
	{ "vmudn",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x06),			MA_RSP, MO_RSPVRSD },
	{ "vmudn",	"Rs,Rt",			MIPS_COP2_RSP(0x06),			MA_RSP, MO_RSPVRSD },
	{ "vmudh",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x07),			MA_RSP, 0 },
	{ "vmudh",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x07),			MA_RSP, 0 },
	{ "vmudh",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x07),			MA_RSP, MO_RSPVRSD },
	{ "vmudh",	"Rs,Rt",			MIPS_COP2_RSP(0x07),			MA_RSP, MO_RSPVRSD },
	{ "vmacf",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x08),			MA_RSP, 0 },
	{ "vmacf",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x08),			MA_RSP, 0 },
	{ "vmacf",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x08),			MA_RSP, MO_RSPVRSD },
	{ "vmacf",	"Rs,Rt",			MIPS_COP2_RSP(0x08),			MA_RSP, MO_RSPVRSD },
	{ "vmacu",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x09),			MA_RSP, 0 },
	{ "vmacu",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x09),			MA_RSP, 0 },
	{ "vmacu",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x09),			MA_RSP, MO_RSPVRSD },
	{ "vmacu",	"Rs,Rt",			MIPS_COP2_RSP(0x09),			MA_RSP, MO_RSPVRSD },
	{ "vrndn",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0a),			MA_RSP, 0 },
	{ "vrndn",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0a),			MA_RSP, 0 },
	{ "vrndn",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0a),			MA_RSP, MO_RSPVRSD },
	{ "vrndn",	"Rs,Rt",			MIPS_COP2_RSP(0x0a),			MA_RSP, MO_RSPVRSD },
	{ "vmacq",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0b),			MA_RSP, 0 },
	{ "vmacq",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0b),			MA_RSP, 0 },
	{ "vmacq",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0b),			MA_RSP, MO_RSPVRSD },
	{ "vmacq",	"Rs,Rt",			MIPS_COP2_RSP(0x0b),			MA_RSP, MO_RSPVRSD },
	{ "vmadl",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0c),			MA_RSP, 0 },
	{ "vmadl",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0c),			MA_RSP, 0 },
	{ "vmadl",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0c),			MA_RSP, MO_RSPVRSD },
	{ "vmadl",	"Rs,Rt",			MIPS_COP2_RSP(0x0c),			MA_RSP, MO_RSPVRSD },
	{ "vmadm",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0d),			MA_RSP, 0 },
	{ "vmadm",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0d),			MA_RSP, 0 },
	{ "vmadm",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0d),			MA_RSP, MO_RSPVRSD },
	{ "vmadm",	"Rs,Rt",			MIPS_COP2_RSP(0x0d),			MA_RSP, MO_RSPVRSD },
	{ "vmadn",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0e),			MA_RSP, 0 },
	{ "vmadn",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0e),			MA_RSP, 0 },
	{ "vmadn",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0e),			MA_RSP, MO_RSPVRSD },
	{ "vmadn",	"Rs,Rt",			MIPS_COP2_RSP(0x0e),			MA_RSP, MO_RSPVRSD },
	{ "vmadh",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x0f),			MA_RSP, 0 },
	{ "vmadh",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x0f),			MA_RSP, 0 },
	{ "vmadh",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x0f),			MA_RSP, MO_RSPVRSD },
	{ "vmadh",	"Rs,Rt",			MIPS_COP2_RSP(0x0f),			MA_RSP, MO_RSPVRSD },
	{ "vadd",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x10),			MA_RSP, 0 },
	{ "vadd",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x10),			MA_RSP, 0 },
	{ "vadd",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x10),			MA_RSP, MO_RSPVRSD },
	{ "vadd",	"Rs,Rt",			MIPS_COP2_RSP(0x10),			MA_RSP, MO_RSPVRSD },
	{ "vsub",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x11),			MA_RSP, 0 },
	{ "vsub",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x11),			MA_RSP, 0 },
	{ "vsub",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x11),			MA_RSP, MO_RSPVRSD },
	{ "vsub",	"Rs,Rt",			MIPS_COP2_RSP(0x11),			MA_RSP, MO_RSPVRSD },
	{ "vsut",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x12),			MA_RSP, 0 },
	{ "vsut",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x12),			MA_RSP, 0 },
	{ "vsut",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x12),			MA_RSP, MO_RSPVRSD },
	{ "vsut",	"Rs,Rt",			MIPS_COP2_RSP(0x12),			MA_RSP, MO_RSPVRSD },
	{ "vabs",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x13),			MA_RSP, 0 },
	{ "vabs",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x13),			MA_RSP, 0 },
	{ "vabs",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x13),			MA_RSP, MO_RSPVRSD },
	{ "vabs",	"Rs,Rt",			MIPS_COP2_RSP(0x13),			MA_RSP, MO_RSPVRSD },
	{ "vaddc",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x14),			MA_RSP, 0 },
	{ "vaddc",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x14),			MA_RSP, 0 },
	{ "vaddc",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x14),			MA_RSP, MO_RSPVRSD },
	{ "vaddc",	"Rs,Rt",			MIPS_COP2_RSP(0x14),			MA_RSP, MO_RSPVRSD },
	{ "vsubc",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x15),			MA_RSP, 0 },
	{ "vsubc",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x15),			MA_RSP, 0 },
	{ "vsubc",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x15),			MA_RSP, MO_RSPVRSD },
	{ "vsubc",	"Rs,Rt",			MIPS_COP2_RSP(0x15),			MA_RSP, MO_RSPVRSD },
	{ "vaddb",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x16),			MA_RSP, 0 },
	{ "vaddb",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x16),			MA_RSP, 0 },
	{ "vaddb",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x16),			MA_RSP, MO_RSPVRSD },
	{ "vaddb",	"Rs,Rt",			MIPS_COP2_RSP(0x16),			MA_RSP, MO_RSPVRSD },
	{ "vsubb",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x17),			MA_RSP, 0 },
	{ "vsubb",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x17),			MA_RSP, 0 },
	{ "vsubb",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x17),			MA_RSP, MO_RSPVRSD },
	{ "vsubb",	"Rs,Rt",			MIPS_COP2_RSP(0x17),			MA_RSP, MO_RSPVRSD },
	{ "vaccb",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x18),			MA_RSP, 0 },
	{ "vaccb",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x18),			MA_RSP, 0 },
	{ "vaccb",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x18),			MA_RSP, MO_RSPVRSD },
	{ "vaccb",	"Rs,Rt",			MIPS_COP2_RSP(0x18),			MA_RSP, MO_RSPVRSD },
	{ "vsucb",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x19),			MA_RSP, 0 },
	{ "vsucb",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x19),			MA_RSP, 0 },
	{ "vsucb",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x19),			MA_RSP, MO_RSPVRSD },
	{ "vsucb",	"Rs,Rt",			MIPS_COP2_RSP(0x19),			MA_RSP, MO_RSPVRSD },
	{ "vsad",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1a),			MA_RSP, 0 },
	{ "vsad",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1a),			MA_RSP, 0 },
	{ "vsad",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1a),			MA_RSP, MO_RSPVRSD },
	{ "vsad",	"Rs,Rt",			MIPS_COP2_RSP(0x1a),			MA_RSP, MO_RSPVRSD },
	{ "vsac",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1b),			MA_RSP, 0 },
	{ "vsac",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1b),			MA_RSP, 0 },
	{ "vsac",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1b),			MA_RSP, MO_RSPVRSD },
	{ "vsac",	"Rs,Rt",			MIPS_COP2_RSP(0x1b),			MA_RSP, MO_RSPVRSD },
	{ "vsum",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1c),			MA_RSP, 0 },
	{ "vsum",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1c),			MA_RSP, 0 },
	{ "vsum",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1c),			MA_RSP, MO_RSPVRSD },
	{ "vsum",	"Rs,Rt",			MIPS_COP2_RSP(0x1c),			MA_RSP, MO_RSPVRSD },
	{ "vsar",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1d),			MA_RSP, 0 },
	{ "vsar",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1d),			MA_RSP, 0 },
	{ "vsar",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1d),			MA_RSP, MO_RSPVRSD },
	{ "vsar",	"Rs,Rt",			MIPS_COP2_RSP(0x1d),			MA_RSP, MO_RSPVRSD },
	{ "vacc",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1e),			MA_RSP, 0 },
	{ "vacc",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1e),			MA_RSP, 0 },
	{ "vacc",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1e),			MA_RSP, MO_RSPVRSD },
	{ "vacc",	"Rs,Rt",			MIPS_COP2_RSP(0x1e),			MA_RSP, MO_RSPVRSD },
	{ "vsuc",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x1f),			MA_RSP, 0 },
	{ "vsuc",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x1f),			MA_RSP, 0 },
	{ "vsuc",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x1f),			MA_RSP, MO_RSPVRSD },
	{ "vsuc",	"Rs,Rt",			MIPS_COP2_RSP(0x1f),			MA_RSP, MO_RSPVRSD },
	{ "vlt",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x20),			MA_RSP, 0 },
	{ "vlt",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x20),			MA_RSP, 0 },
	{ "vlt",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x20),			MA_RSP, MO_RSPVRSD },
	{ "vlt",	"Rs,Rt",			MIPS_COP2_RSP(0x20),			MA_RSP, MO_RSPVRSD },
	{ "veq",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x21),			MA_RSP, 0 },
	{ "veq",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x21),			MA_RSP, 0 },
	{ "veq",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x21),			MA_RSP, MO_RSPVRSD },
	{ "veq",	"Rs,Rt",			MIPS_COP2_RSP(0x21),			MA_RSP, MO_RSPVRSD },
	{ "vne",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x22),			MA_RSP, 0 },
	{ "vne",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x22),			MA_RSP, 0 },
	{ "vne",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x22),			MA_RSP, MO_RSPVRSD },
	{ "vne",	"Rs,Rt",			MIPS_COP2_RSP(0x22),			MA_RSP, MO_RSPVRSD },
	{ "vge",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x23),			MA_RSP, 0 },
	{ "vge",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x23),			MA_RSP, 0 },
	{ "vge",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x23),			MA_RSP, MO_RSPVRSD },
	{ "vge",	"Rs,Rt",			MIPS_COP2_RSP(0x23),			MA_RSP, MO_RSPVRSD },
	{ "vcl",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x24),			MA_RSP, 0 },
	{ "vcl",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x24),			MA_RSP, 0 },
	{ "vcl",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x24),			MA_RSP, MO_RSPVRSD },
	{ "vcl",	"Rs,Rt",			MIPS_COP2_RSP(0x24),			MA_RSP, MO_RSPVRSD },
	{ "vch",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x25),			MA_RSP, 0 },
	{ "vch",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x25),			MA_RSP, 0 },
	{ "vch",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x25),			MA_RSP, MO_RSPVRSD },
	{ "vch",	"Rs,Rt",			MIPS_COP2_RSP(0x25),			MA_RSP, MO_RSPVRSD },
	{ "vcr",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x26),			MA_RSP, 0 },
	{ "vcr",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x26),			MA_RSP, 0 },
	{ "vcr",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x26),			MA_RSP, MO_RSPVRSD },
	{ "vcr",	"Rs,Rt",			MIPS_COP2_RSP(0x26),			MA_RSP, MO_RSPVRSD },
	{ "vmrg",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x27),			MA_RSP, 0 },
	{ "vmrg",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x27),			MA_RSP, 0 },
	{ "vmrg",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x27),			MA_RSP, MO_RSPVRSD },
	{ "vmrg",	"Rs,Rt",			MIPS_COP2_RSP(0x27),			MA_RSP, MO_RSPVRSD },
	{ "vand",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x28),			MA_RSP, 0 },
	{ "vand",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x28),			MA_RSP, 0 },
	{ "vand",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x28),			MA_RSP, MO_RSPVRSD },
	{ "vand",	"Rs,Rt",			MIPS_COP2_RSP(0x28),			MA_RSP, MO_RSPVRSD },
	{ "vnand",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x29),			MA_RSP, 0 },
	{ "vnand",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x29),			MA_RSP, 0 },
	{ "vnand",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x29),			MA_RSP, MO_RSPVRSD },
	{ "vnand",	"Rs,Rt",			MIPS_COP2_RSP(0x29),			MA_RSP, MO_RSPVRSD },
	{ "vor",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x2a),			MA_RSP, 0 },
	{ "vor",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x2a),			MA_RSP, 0 },
	{ "vor",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x2a),			MA_RSP, MO_RSPVRSD },
	...
	{ "vnor",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x2b),			MA_RSP, MO_RSPVRSD },
	...
	{ "vxor",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x2c),			MA_RSP, MO_RSPVRSD },
	...
	{ "vnxor",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x2d),			MA_RSP, MO_RSPVRSD },
	{ "vnxor",	"Rs,Rt",			MIPS_COP2_RSP(0x2d),			MA_RSP, MO_RSPVRSD },
	{ "vrcp",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x30),			MA_RSP, 0 },
	{ "vrcpl",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x31),			MA_RSP, 0 },
	{ "vrcph",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x32),			MA_RSP, 0 },
	{ "vmov",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x33),			MA_RSP, 0 },
	{ "vrsq",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x34),			MA_RSP, 0 },
	{ "vrsql",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x35),			MA_RSP, 0 },
	{ "vrsqh",	"Rd[Rm],Rt[Rl]",	MIPS_COP2_RSP(0x36),			MA_RSP, 0 },
	{ "vnop",	"",					MIPS_COP2_RSP(0x37),			MA_RSP, 0 },
	{ "vextt",	"Rd,Rs,Rt[Re]",		MIPS_COP2_RSP(0x38),			MA_RSP, 0 },
	{ "vextt",	"Rd,Rs,Rt",			MIPS_COP2_RSP(0x38),			MA_RSP, 0 },
	{ "vextt",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x38),			MA_RSP, MO_RSPVRSD },
	...
	{ "vextq",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x39),			MA_RSP, MO_RSPVRSD },
	...
	{ "vextn",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x3a),			MA_RSP, MO_RSPVRSD },
	...
	{ "vinst",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x3c),			MA_RSP, MO_RSPVRSD },
	...
	{ "vinsq",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x3d),			MA_RSP, MO_RSPVRSD },
	...
	{ "vinsn",	"Rs,Rt[Re]",		MIPS_COP2_RSP(0x3e),			MA_RSP, MO_RSPVRSD },
...
//  11 |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  | 18..1F
//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
	{"lbv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"lbv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"lbv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"lbv",		"Rt,(s)",			MIPS_LWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"lsv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"lsv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"lsv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"lsv",		"Rt,(s)",			MIPS_LWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"llv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"llv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"llv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"llv",		"Rt,(s)",			MIPS_LWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"ldv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"ldv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"ldv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"ldv",		"Rt,(s)",			MIPS_LWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"lqv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"lqv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"lqv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"lqv",		"Rt,(s)",			MIPS_LWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"lrv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"lrv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"lrv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"lrv",		"Rt,(s)",			MIPS_LWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"lpv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"lpv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"lpv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"lpv",		"Rt,(s)",			MIPS_LWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"luv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"luv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"luv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"luv",		"Rt,(s)",			MIPS_LWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"lhv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"lhv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"lhv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"lhv",		"Rt,(s)",			MIPS_LWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"lfv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"lfv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"lfv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"lfv",		"Rt,(s)",			MIPS_LWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"lwv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"lwv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"lwv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"lwv",		"Rt,(s)",			MIPS_LWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"ltv",		"Rt[Re],i7(s)",		MIPS_LWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"ltv",		"Rt[Re],(s)",		MIPS_LWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"ltv",		"Rt,i7(s)",			MIPS_LWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"ltv",		"Rt,(s)",			MIPS_LWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
...
//  11 |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  | 18..1F
//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
	{"sbv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"sbv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"sbv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"sbv",		"Rt,(s)",			MIPS_SWC2_RSP(0x00),			MA_RSP, MO_RSP_VEALT },
	{"ssv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"ssv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"ssv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"ssv",		"Rt,(s)",			MIPS_SWC2_RSP(0x01),			MA_RSP, MO_RSP_VEALT },
	{"slv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"slv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"slv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"slv",		"Rt,(s)",			MIPS_SWC2_RSP(0x02),			MA_RSP, MO_RSP_VEALT },
	{"sdv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"sdv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"sdv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"sdv",		"Rt,(s)",			MIPS_SWC2_RSP(0x03),			MA_RSP, MO_RSP_VEALT },
	{"sqv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"sqv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"sqv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"sqv",		"Rt,(s)",			MIPS_SWC2_RSP(0x04),			MA_RSP, MO_RSP_VEALT },
	{"srv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"srv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"srv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"srv",		"Rt,(s)",			MIPS_SWC2_RSP(0x05),			MA_RSP, MO_RSP_VEALT },
	{"spv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"spv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"spv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"spv",		"Rt,(s)",			MIPS_SWC2_RSP(0x06),			MA_RSP, MO_RSP_VEALT },
	{"suv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"suv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"suv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"suv",		"Rt,(s)",			MIPS_SWC2_RSP(0x07),			MA_RSP, MO_RSP_VEALT },
	{"shv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"shv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"shv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"shv",		"Rt,(s)",			MIPS_SWC2_RSP(0x08),			MA_RSP, MO_RSP_VEALT },
	{"sfv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"sfv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"sfv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"sfv",		"Rt,(s)",			MIPS_SWC2_RSP(0x09),			MA_RSP, MO_RSP_VEALT },
	{"swv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"swv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"swv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"swv",		"Rt,(s)",			MIPS_SWC2_RSP(0x0a),			MA_RSP, MO_RSP_VEALT },
	{"stv",		"Rt[Re],i7(s)",		MIPS_SWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"stv",		"Rt[Re],(s)",		MIPS_SWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"stv",		"Rt,i7(s)",			MIPS_SWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	{"stv",		"Rt,(s)",			MIPS_SWC2_RSP(0x0b),			MA_RSP, MO_RSP_VEALT },
	// END
	{ NULL,		NULL,		0,			0 }
};
