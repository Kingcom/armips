...
#define GB_IMMEDIATE_U3			0x00000002
#define GB_IMMEDIATE_U8			0x00000004
#define GB_IMMEDIATE_S8			0x00000008
#define GB_IMMEDIATE_U16		0x00000010
#define GB_STOP					0x00000020
#define GB_RST					0x00000040
#define GB_LOAD_REG8_REG8		0x00000080
#define GB_ADD_SUB_IMMEDIATE	0x00000100
#define GB_NEGATE_IMM			0x00000200
#define GB_JUMP_RELATIVE		0x00000400

#define GB_HAS_IMMEDIATE		( GB_IMMEDIATE_U3 | GB_IMMEDIATE_U8 | GB_IMMEDIATE_S8 \
								| GB_IMMEDIATE_U16 | GB_RST | GB_JUMP_RELATIVE )
